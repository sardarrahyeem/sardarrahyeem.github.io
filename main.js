...
var ServicesComponent = /** @class */ (function () {
    function ServicesComponent() {
        ...
        this.services = [
            ...
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](5, "Web Development", "We offer highly tailored web development services for the business owners around the world. Our custom web solutions have the ability to streamline business processes and prove a cutting edge source for enhancing your business success.", "We offer highly tailored web development services for the business owners around the world. Our custom web solutions have the ability to streamline business processes and prove a cutting edge source for enhancing your business success.", "", "col-md-6 col-lg-5 offset-lg-1 wow bounceInUp", "0.2s", "1.4s", "#d6ff22", "ion-ios-world-outline", "", "assets/img/serviceImgs/web-dev.png"),
