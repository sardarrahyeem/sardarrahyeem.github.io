...
var Service = /** @class */ (function () {
    function Service(serviceId, serviceName, serviceDescription, serviceDetail, link, cssClass, dataWowDelay, dataWowDuration, styleColor, icon, serviceImage) {
...
var ServicesComponent = /** @class */ (function () {
    function ServicesComponent() {
        ...
        this.services = [
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](1, "Robotics Process Automation", "With Robotic Process Automation (RPA) implementation, we can help improve the efficiency and effectiveness of your business operations faster and at a lower cost than other automation approaches.", "With Robotic Process Automation (RPA) implementation, we can help improve the efficiency and effectiveness of your business operations faster and at a lower cost than other automation approaches. We use the software tools like BluePrism, Automation anywhere and UIPath, to capture and interpret existing IT applications to enable transaction processing, data manipulation and communication across multiple IT systems.", "", "col-md-6 col-lg-5 offset-lg-1 wow bounceInUp", "0s", "1.4s", "#ff689b", "ion-ios-analytics-outline", "assets/img/rpa2.png"),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](2, "Web Design", "NexTech UK specialize in the art of merging elegance with logical navigation structuring. We ensure that your website acts as store front of your company and optimizes the market potential of the website.", "NexTech UK specialize in the art of merging elegance with logical navigation structuring. We ensure that your website acts as store front of your company and optimizes the market potential of the website.", "", "col-md-6 col-lg-5 wow bounceInUp", "0s", "1.4s", "#e9bf06", "ion-ios-bookmarks-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](3, "Graphic Designing", "Graphic designs have the ability to attract the attention of the users resulting in more positive feedback and revisits. We carry the competency of merging creative ideas with the latest technology to develop outrageous solutions for you.", "Graphic designs have the ability to attract the attention of the users resulting in more positive feedback and revisits. We carry the competency of merging creative ideas with the latest technology to develop outrageous solutions for you.", "", "col-md-6 col-lg-5 offset-lg-1 wow bounceInUp", "0.1s", "1.4s", "#3fcdc7", "ion-ios-paper-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](4, "Software Development", "At NexTech UK software developers work as partners along with the clients and gain deep insights into their project requirements. They also provide support and maintenance of the introduced solution in an expert way.", "At NexTech UK software developers work as partners along with the clients and gain deep insights into their project requirements. They also provide support and maintenance of the introduced solution in an expert way.", "", "col-md-6 col-lg-5 wow bounceInUp", "0.1s", "1.4s", "#41cf2e", "ion-ios-speedometer-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](5, "Web Development", "We offer highly tailored web development services for the business owners around the world. Our custom web solutions have the ability to streamline business processes and prove a cutting edge source for enhancing your business success.", "We offer highly tailored web development services for the business owners around the world. Our custom web solutions have the ability to streamline business processes and prove a cutting edge source for enhancing your business success.", "", "col-md-6 col-lg-5 offset-lg-1 wow bounceInUp", "0.2s", "1.4s", "#d6ff22", "ion-ios-world-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](6, "Search Engine Optimization", "We follow a very comprehensive and vibrant model of SEO and SMM in order to move systematically and reach the desired results. SEO is an iterative and continuous process of building and maintaining pathways from your website to Internet users.", "We follow a very comprehensive and vibrant model of SEO and SMM in order to move systematically and reach the desired results. SEO is an iterative and continuous process of building and maintaining pathways from your website to Internet users.", "", "col-md-6 col-lg-5 wow bounceInUp", "0.2s", "1.4s", "#4680ff", "ion-ios-clock-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](7, "", "", "", "", "col-md-6 col-lg-5 wow bounceInUp", "0.3s", "1.4s", "#4680ff", "ion-ios-cloudy-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](8, "", "", "", "", "col-md-6 col-lg-5 wow bounceInUp", "0.3s", "1.4s", "#4680ff", "ion-ios-cloudy-outline", ""),
            new _service__WEBPACK_IMPORTED_MODULE_2__["Service"](9, "", "", "", "", "col-md-6 col-lg-5 wow bounceInUp", "0.3s", "1.4s", "#4680ff", "ion-ios-cloudy-outline", "")
        ];
    }
